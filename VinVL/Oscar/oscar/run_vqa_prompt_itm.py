...
class ImageBertForSequenceClassificationPromptStage2(ImageBertForSequenceClassification):
...
MODEL_CLASSES = {
    'bert': (BertConfig, ImageBertForSequenceClassificationPromptStage2, BertTokenizer),
}
...
def compute_score_with_preds(preds, labels):
    one_hots = torch.zeros(*labels.size()).cuda()
